...
# ID を一覧から選定して召喚
    execute if score $Random Temporary matches 0000..0999 run function world_manager:gimmick/darkness/penalty/pick.m {Level:0}
    execute if score $Random Temporary matches 1000..2899 run function world_manager:gimmick/darkness/penalty/pick.m {Level:1}
    execute if score $Random Temporary matches 2900..5399 run function world_manager:gimmick/darkness/penalty/pick.m {Level:2}
    execute if score $Random Temporary matches 5400..7499 run function world_manager:gimmick/darkness/penalty/pick.m {Level:3}
    execute if score $Random Temporary matches 7500.. run function world_manager:gimmick/darkness/penalty/pick.m {Level:4}
